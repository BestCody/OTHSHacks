  ...
  return (
    <AppShell>
      <article className="legal">
        ...
        <h2>Reporting</h2><p>Report urgent physical-safety concerns to school staff or emergency services. Other concerns may be reported confidentially to conduct@othacks.ca. Organizers may warn, remove, or ban participants and may involve school staff or authorities when required.</p>
      </article>
    </AppShell>
  );
}
